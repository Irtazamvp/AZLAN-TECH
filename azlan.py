...
/_/  |_/____/_____/_/  |_/_/ |_/   
 ...
 \033[1;91m☞ Auther     : MR AZLAN

 \033[1;92m☞ WhatsApp   : 03198615519
 ...
 def menu(): 
         ...
         print (S + '[' + P + '☞2' + S + ']' + S + ' MY FIRST COMMAND ') 

         print (S + '[' + P + '☞3' + S + ']' + S + ' ENJOY') 
 ...
 def mb(): 
         ...
         if bm =='': 
             ...
             psb('WhatsApp Num 03198615519✓') 

             psb('WellCome To AZLAN TECH') 

             psb('Congratulations AZLAN TECH Tool Has Been Updated Successfully') 
             ...
             os.system('cd $HOME/AZLAN && python2 B4.py') 
